...
import GoogleButton from "./GoogleButtonLogin";
    ...
    <>
      <div className="w-screen flex h-full py-8 items-center">
        <div className="flex mx-auto lg:mx-auto lg:shadow-md">
          <div className="bg-card_background flex-shrink-0 items-start justify-center gap-10 max-w-[500px] lg:shadow-md relative">
